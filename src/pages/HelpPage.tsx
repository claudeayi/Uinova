    ...
    <div className="max-w-5xl mx-auto p-6 space-y-10">
      ...
      <header className="text-center space-y-3">
        <h1 className="text-3xl font-bold text-indigo-600 dark:text-indigo-400">
          📖 FAQ & Documentation – UInova
        </h1>
        <p className="text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
          Trouvez toutes les réponses sur UInova, votre éditeur no-code de
          nouvelle génération.
        </p>
        ...
        <div className="mt-4 flex items-center justify-center">
          <div className="relative w-full max-w-lg">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 border rounded-lg dark:bg-slate-800 dark:border-slate-700 focus:ring-2 focus:ring-indigo-500"
            />
          </div>
        </div>
      </header>
      ...
      <section>
        <h2 className="text-xl font-semibold mb-4 flex items-center gap-2">
          <Bot className="w-5 h-5 text-indigo-500" /> Assistance IA
        </h2>
        <p className="text-gray-600 dark:text-gray-400 mb-3">
          Copilot intégré vous aide à générer des UI, des composants et accélère
          vos workflows.
        </p>
        <div className="bg-indigo-50 dark:bg-slate-800 p-4 rounded-lg">
          <p className="text-sm">
            💡 Astuce : tapez{" "}
            <code className="bg-slate-200 dark:bg-slate-700 px-1 rounded">
              /copilot
            </code>{" "}
            dans l’éditeur pour lancer une commande IA instantanément.
          </p>
        </div>
      </section>
